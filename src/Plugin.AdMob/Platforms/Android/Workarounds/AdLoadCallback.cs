...
/// Source: https://github.com/xamarin/GooglePlayServicesComponents/issues/425
/// </summary>
public abstract class RewardedInterstitialAdLoadCallback : Android.Gms.Ads.RewardedInterstitial.RewardedInterstitialAdLoadCallback
{
    [Register("onAdLoaded", "(Lcom/google/android/gms/ads/rewardedinterstitial/RewardedInterstitialAd;)V", "GetOnAdLoadedHandler")]
    public virtual void OnAdLoaded(Android.Gms.Ads.RewardedInterstitial.RewardedInterstitialAd rewardedInterstitialAd)
    {
    ...
    private static void n_onAdLoaded(IntPtr jnienv, IntPtr native__this, IntPtr native_p0)
    {
        RewardedInterstitialAdLoadCallback thisobject = GetObject<RewardedInterstitialAdLoadCallback>(jnienv, native__this, JniHandleOwnership.DoNotTransfer);
        Android.Gms.Ads.RewardedInterstitial.RewardedInterstitialAd resultobject = GetObject<Android.Gms.Ads.RewardedInterstitial.RewardedInterstitialAd>(native_p0, JniHandleOwnership.DoNotTransfer);
        thisobject.OnAdLoaded(resultobject);
    }
}
